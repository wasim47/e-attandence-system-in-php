		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content pb-20">
                     ...
                     <?php echo form_open('index/userLogin', array('class'=>'form-validate')); ?>
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class="icon-object border-slate-300 text-slate-300">
                                <img src="<?php echo base_url('asset/admin/images');?>"  style="width:90%; height:auto"/></div>
							...
							<span class="help-block text-center no-margin">Design & Develop By <a href="http://copotronic.com" target="_blank">Copotyronic InfoSystem Ltd</a></span>
						</div>
					 <?php echo form_open();?>
